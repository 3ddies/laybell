...
export function usePostActionSheets() {
  ...
  // "Laybell TV" with no session up: the video waits here while the connect
  // wizard runs, then plays the moment the TV connects (mirrors the provider).
  ...
  const sheetsOpen = shareVisible || optsVisible || !!playlistPostId || !!gifVideo || !!tvConnect;
