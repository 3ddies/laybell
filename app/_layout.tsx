  ...
  return (
    <PostOptionsProvider>
      ...
      >
        ...
        {['messages/index', 'notifications', 'settings', 'analytics', 'spotlight', 'ad-manager/index', 'ad-manager/create', 'ad-manager/[id]', 'badges', 'permissions', 'playlists', 'playlist/[id]', 'downloads', 'premium', 'communities/index', 'communities/create', 'communities/edit', 'communities/[id]', 'privacy-policy', 'terms-of-service', 'community-guidelines', 'advertiser-terms', 'privacy-center'].map((name) => (
          <Stack.Screen
            key={name}
            name={name}
            options={{
