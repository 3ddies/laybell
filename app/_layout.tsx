  ...
  return (
    <PostOptionsProvider>
      ...
      >
        ...
        {['messages/index', 'notifications', 'settings', 'saved', 'gifs', 'analytics', 'post-analytics/[id]', 'spotlight', 'ad-manager/index', 'ad-manager/create', 'ad-manager/[id]', 'badges', 'permissions', 'playlists', 'playlist/[id]', 'downloads', 'premium', 'follower-insights', 'communities/index', 'communities/create', 'communities/edit', 'communities/[id]', 'privacy-policy', 'terms-of-service', 'community-guidelines', 'advertiser-terms', 'marketplace-terms', 'privacy-center', 'live/index', 'live/go-live', 'studio/index', 'studio/[id]', 'shop/index', 'shop/[userId]', 'shop/listing/[id]', 'shop/new-listing', 'shop/cart', 'wallet', 'tv/index',
