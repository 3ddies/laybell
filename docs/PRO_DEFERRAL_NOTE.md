...
| **ASCAP** | 🟡 **Submitted + paid 2026-08-02 — awaiting written confirmation** | Website & Mobile App licence bought through the self-serve form (<https://licensing.ascap.com/?type=digital>) after the 07-28 *email* route turned out to be an enquiry, not a filing. **$336.00/yr, term 08/01/2026 → 07/31/2027.** Declared: On Demand + Video, 25,000 annual sessions, $0 revenue, `laybell.app` / app "Laybell". The payment page timed out after paying and re-entry was duplicate-blocked, but **the $336 charge was CONFIRMED pending on the card 2026-08-02** — so the transaction completed and only the display failed. Since ASCAP will not accept an application without payment at submission, the application is in. **Remaining:** the acceptance email + licence PDF, quoted at **5-7 business days** (~2026-08-11); then register at ascap.com/mylicense and save the PDF + account number here. Do NOT resubmit. Nothing landed by the 08-11 date, so chased **2026-08-12**: ASCAP's **licensing dept direct line is (615) 742-5017** (Nashville) — use that rather than the general **(800) 505-4052**. Phone only; email is what stalled the first attempt. **Voicemail left 2026-08-12** — no answer on the direct line. Treat that voicemail the way the 07-28 email should have been treated: it leaves no ticket and no confirmation, so silence proves nothing. **Call again if there is no callback within 2 business days (by ~2026-08-14)** rather than waiting on it. Before waiting at all, check **ascap.com/mylicense** with the purchase email — the licence may already be issued and only the acceptance email failed to arrive — and check spam. A status email to `weblicense@ascap.com` is safe and is NOT a resubmission; the never-resubmit rule covers the purchase form only. |
