...
| **ASCAP** | 🟡 **Submitted + paid 2026-08-02 — awaiting written confirmation** | Website & Mobile App licence bought through the self-serve form (<https://licensing.ascap.com/?type=digital>) after the 07-28 *email* route turned out to be an enquiry, not a filing. **$336.00/yr, term 08/01/2026 → 07/31/2027.** Declared: On Demand + Video, 25,000 annual sessions, $0 revenue, `laybell.app` / app "Laybell". ⚠️ **The payment page TIMED OUT after paying;** re-entry was blocked as a duplicate account, which means the record exists on their side. ASCAP will not accept an application without payment at submission, so this is very likely complete — **but verify, don't assume:** (1) confirm a $336 charge on the card, (2) expect the acceptance email + licence PDF within **5-7 business days** (i.e. by ~2026-08-11), (3) register at ascap.com/mylicense from the emailed instructions. **Do NOT resubmit — double-charge risk.** If nothing lands, call **(800) 505-4052** (phone, not email — email is what stalled this the first time). Save the PDF + account number here when they arrive. |
