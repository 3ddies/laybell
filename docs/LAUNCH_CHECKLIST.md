...
| Version | iOS | Android |
|---|---|---|
| 1.0.5 (build 13) | 🚀 **BUILT + UPLOADED to ASC 2026-09-25** (build `4dccacf1`, submission `e38e3d80`, Apple processing); React + profile views bundled onto 1.0.4, gates green; **owner: create version, What's New, select build 13, Submit for Review** | ⏳ not built |
